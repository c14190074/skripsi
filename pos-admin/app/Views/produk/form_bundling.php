                        ...
                        <?php
                          if($supplier_data) {
                            foreach($supplier_data as $supplier) {
                              echo "<option value='".$supplier['supplier_id']."'>".strtoupper($supplier['nama_supplier'])."</option>";
                            }
                          }
                        ...
                        <?php
                          if($kategori_data) {
                            foreach($kategori_data as $kategori) {
                              echo "<option value='".$kategori['kategori_id']."'>".strtoupper($kategori['nama_kategori'])."</option>";
                            }
                          }
